      ...
      <div className="max-w-md w-full">
        ...
        <div className="flex justify-end mb-8">
          <button
            ...
            className="flex items-center px-4 py-2 text-gray-500 hover:text-white hover:bg-gray-500 rounded-full transition-all duration-200 transform hover:scale-105 border border-gray-300 hover:border-gray-500"
          >
            <span className="text-sm mr-2 font-medium">Skip</span>
            ...
            <div className="w-20">
              {currentSlide > 0 && (
                <button
                  ...
                  className="px-4 py-2 text-gray-500 hover:text-white hover:bg-gray-500 rounded-full transition-all duration-200 transform hover:scale-105 border border-gray-300 hover:border-gray-500 font-medium"
                >
                  Back
                </button>
              )}
